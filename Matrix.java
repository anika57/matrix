...
public class Matrix implements ActionListener 
{
     ...
     private static JButton minusB, plusB, inverseB,
             ...
             newMatrix,sci;
     private static JPanel choosePanel [] = new JPanel[10];
	...
	sci=new JButton("Scientific Calculator");
	sci.setPreferredSize(new Dimension(175,35));
	sci.addActionListener(this);
	choosePanel[0].add(sci);
    ...
    private static void divideByScaler ()
{
    ...
    JOptionPane.showMessageDialog(null, String.format("Determination's Value = %.2f", getValue(myMatrix) )  , null, JOptionPane.PLAIN_MESSAGE, null);
        }
    }//end gui get Value
